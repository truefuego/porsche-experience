...
import { RaceBredPrecision } from "./SidePanelDetails";
          ...
          <div ref={containerRef} className="h-[800vh] relative">
            ...
            >
              <div className="w-screen h-screen flex items-end justify-center text-white">
                ...
                <div className="flex flex-col w-screen mb-16 gap-4">
                  <p className="text-6xl sm:text-8xl md:text-9xl xl:text-9xl 2xl:text-[10rem] ml-4">
                    Porsche
                  </p>
                  <p className="text-7xl sm:text-[8rem] md:text-[11rem] xl:text-[16rem] 2xl:text-[19rem] text-end xl:leading-[14rem] mb-0 mr-4">
                    911 GT3 R
                  </p>
                </div>
              </div>
            ...
            >
              <div className="w-screen h-screen flex gap-12 flex-col items-center mt-[60vh]">
                <p
                  className="text-xl md:text-3xl text-white font-medium"
                  onClick={() => setIsFirstModalOpen(true)}
                >
                  Engineered for precision and dominance
                </p>
                <OpenPanelButton
                  text="Race-Bred Precision"
                  setIsVisible={setIsFirstModalOpen}
                  classes=""
                />
              </div>
            </VideoParallaxDetailsScreenWrapper>
            ...
            >
              <div className="w-screen h-screen flex gap-12 flex-col items-center mt-[20vh]">
                ...
                >
                  Track-Bred Performance Machine
                </p>
                <OpenPanelButton
                  text="Race Proven"
                  setIsVisible={setIsSecondModalOpen}
                  classes=""
                />
              </div>
            </VideoParallaxDetailsScreenWrapper>
            ...
            >
              <div className="w-screen h-screen flex gap-12 flex-col ml-[20vw] mt-[20vh]">
                ...
                <OpenPanelButton
                  text="Race Proven"
                  setIsVisible={setIsThirdModalOpen}
                  classes=""
                />
              </div>
            </VideoParallaxDetailsScreenWrapper>
            ...
            >
              <div className="w-screen h-screen flex gap-6 flex-col ml-[20vw] mt-[10vh]">
                ...
                <OpenPanelButton
                  text="Race Proven"
                  setIsVisible={setIsFourthModalOpen}
                  classes=""
                />
              </div>
            </VideoParallaxDetailsScreenWrapper>
